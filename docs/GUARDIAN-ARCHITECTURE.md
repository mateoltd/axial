...
- Launch integrity authority is live, incarnation-bound, captured-root-bound, and pointer-current; persisted evidence cannot hydrate it. Tier 0 performs no content I/O, while suspicion-gated Tier 1 retains that live authority across bounded hashing and revalidates it before redacted facts can escape.
