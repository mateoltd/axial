...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| PersistedStateRepairAdmission | PersistedStateRepairAttempt | PersistedStateRepairTerminal | Startup | Managed | persisted_state_schema_invalid | store, record_id, physical_identity, mode | 1 | 24 | axial.state.operation_journals.v8 | axial.guardian.failure_memory.v6 | Quarantined, Refused, AppliedUnverified |
